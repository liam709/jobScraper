//Web Crawler Application for various job boards
...
const fetchCareerBeaconJobs = () => {

}

const fetchZipRecruiterJobs = () => {

}

const fetchMonsterJobs = () => {

}

const fetchTechNLJobs = () => {
